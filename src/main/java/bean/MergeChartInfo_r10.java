 ...
 * チャート情報クラス。
 */
public class MergeChartInfo_r10 {
	/**
	 * 4本値チャートＤＢファイルのカラム数。
	 */
	 ...
	 */
	public MergeChartInfo_r10(String date) {
		this.date = date;
		this.openPrice = 0;
		this.highPrice = 0;
		this.lowPrice = 0;
	 ...
	 */
	public MergeChartInfo_r10(String[] cols) {
		int i = 0;
		this.date = cols[i++];
	 ...
	 * @param volume 売買高。
	 */
	public MergeChartInfo_r10(String date, int price, int volume) {
		this.date = date;
	 ...
	 */
	public MergeChartInfo_r10(String date, int price, int volume, int flag) {
		this.date = date;
		this.openPrice = price;
		this.highPrice = price;
		this.lowPrice = price;
